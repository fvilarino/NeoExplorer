...
object AppPreferencesModule {
   ...
   *
   * The backing file is stored in the app's private files directory and outlives any individual
   * Activity or ViewModel. A dedicated [SupervisorJob] is used so that DataStore failures don't
   * cancel the rest of the app's coroutine hierarchy.
   */
  @Provides
