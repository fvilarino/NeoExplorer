...
private interface NeoWsService {
  ...
  @GET("neo/{asteroid_id}")
  suspend fun lookupAsteroid(@Path("asteroid_id") asteroidId: String): NearEarthObjectDto
...
class NeoDataSourceImpl(@param:NeoWsRetrofit private val neoWsRetrofit: retrofit2.Retrofit) :
  NeoDataSource {
