...
internal fun NearEarthObjectDto.toDomain(): NearEarthObject =
  NearEarthObject(
    id = AsteroidId(id),
...
internal fun CloseApproachDataDto.toDomain(): CloseApproachData =
  CloseApproachData(
    closeApproachDate = LocalDate.parse(closeApproachDate),
    relativeVelocityKmPerSecond =
      KilometersPerSecond(relativeVelocity.kilometersPerSecond.toDouble()),
...
internal fun NeoFeedResponse.toDomain(): NeoFeed =
  NeoFeed(
