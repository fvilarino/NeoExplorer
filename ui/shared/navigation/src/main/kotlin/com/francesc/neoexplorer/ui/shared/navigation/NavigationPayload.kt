...
/**
 * A one-shot wrapper around a list of [Screen]s to navigate to. Mirrors the DeeplinkPayload pattern
 * from PasswordManagerCompose.
 */
class NavigationPayload(private val screens: List<Screen>) {
